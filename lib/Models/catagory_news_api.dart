class CatgeriyNewsApi {
  String? status;
  int? totalResults;
  List<Articles>? articles;

  CatgeriyNewsApi({this.status, this.totalResults, this.articles});

  CatgeriyNewsApi.fromJson(Map<String, dynamic> json) {
    status = json["status"];
