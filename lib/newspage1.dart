...
import 'package:form/categories_screen.dart';
...
enum FilterList{ bbcNews,independent, reuters,cnn, aljazeera, abcnews}
      ...
      body: ListView(
        children: [
          SizedBox(
            height: hieght * .55,
            width: width,
            child: FutureBuilder<modelBBCnewsheadlines>(
                future: newsviewModel1.fetchNewchannelHeadlinesApi(name),
          ...
          child:FutureBuilder<CatgeriyNewsApi>(
              future: newsviewModel1.fetchCategoriesNewsApi('General'),
              builder: (BuildContext context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(
                    child: SpinKitCircle(
